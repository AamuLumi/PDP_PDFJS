 ...
 * @param {name} String The name of the file, without the file extension
 ...
 * @param {id} String The file Id as generated by the Collection
 * @param {filename} String The full name of the file, with file extension
 */
